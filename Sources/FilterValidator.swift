...
struct FilterValidator {
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: Logger.Level,
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: Logger.Level) -> Bool {
