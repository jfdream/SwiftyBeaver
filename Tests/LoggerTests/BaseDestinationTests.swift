...
class BaseDestinationTests: XCTestCase {
    ...
    func testMessageToJSON() {
        ...
        XCTAssertEqual(level, Logger.Level.info.rawValue)
    ...
    func testLevelWord() {
        ...
        str = obj.levelWord(Logger.Level.verbose)
        XCTAssertNotNil(str, "VERBOSE")
        str = obj.levelWord(Logger.Level.debug)
        XCTAssertNotNil(str, "DEBUG")
        str = obj.levelWord(Logger.Level.info)
        XCTAssertNotNil(str, "INFO")
        str = obj.levelWord(Logger.Level.warning)
        XCTAssertNotNil(str, "WARNING")
        str = obj.levelWord(Logger.Level.error)
    ...
    func testColorForLevel() {
        ...
        // empty on default
        str = obj.colorForLevel(Logger.Level.verbose)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(Logger.Level.debug)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(Logger.Level.info)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(Logger.Level.warning)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(Logger.Level.error)
        XCTAssertNotNil(str, "")
    ...
    func test_init_noMinLevelSet() {
        ...
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.verbose, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.error, path: "", function: ""))
    }

    func test_init_minLevelSet() {
        let destination = BaseDestination()
        destination.minLevel = Logger.Level.info
        XCTAssertFalse(destination.shouldLevelBeLogged(Logger.Level.verbose, path: "", function: ""))
        XCTAssertFalse(destination.shouldLevelBeLogged(Logger.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.error, path: "", function: ""))
    }
    ...
    func test_shouldLevelBeLogged_hasMinLevel_True() {
        let destination = BaseDestination()
        destination.minLevel = Logger.Level.verbose
        destination.addFilter(Filters.Path.equals("/world/beaver.swift", caseSensitive: true, required: true))
        XCTAssertTrue(destination.shouldLevelBeLogged(Logger.Level.warning,
    ...
    func test_shouldLevelBeLogged_hasMinLevelAndOneRequiredMessageFilterAndDoesPass_True() {
        let destination = BaseDestination()
        destination.minLevel = Logger.Level.error
        destination.addFilter(Filters.Message.contains("Required", caseSensitive: false, required: true, minLevel: .info))
